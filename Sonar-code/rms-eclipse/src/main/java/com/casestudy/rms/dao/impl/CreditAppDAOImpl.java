...
public class CreditAppDAOImpl implements CreditAppDAO {
	...
	public void submitCreditAppForm(CreditApplication creditApp) {
		...
		try {
			...
			LOGGER.error("CreditAppDAOImpl :: submitCreditAppForm  "+exception.getMessage());
	...
	public List<CreditApplication> getCreditApplication(int faid, int status) {
		...
		try {
			...
			LOGGER.error("CreditAppDAOImpl :: getCreditApplication  "+exception.getMessage());
			throw new DAOException(ApplicationConstant.PROBLEM_OCCURED_MSG);
		} finally {
			entityManager.close();
		}
	...
	public int getMaxApplicationIdId() {
		...
		try {
			...
			LOGGER.error("CreditAppDAOImpl :: getMaxApplicationIdId "+exception.getMessage());
			throw new DAOException(ApplicationConstant.PROBLEM_OCCURED_MSG);
		} finally {
			entityManager.close();
		}
	...
	public boolean assignCreditApplication(CreditApplication creditApp) {
		...
		try {
			...
			LOGGER.error("CreditAppDAOImpl :: assignCreditApplication  "+exception.getMessage());
			throw new DAOException(ApplicationConstant.PROBLEM_OCCURED_MSG);
		} finally {
			entityManager.close();
	...
	public void updateCreditScore(int applicationId, int creditScore, int applicationStatus) {
		...
		try {
			...
			LOGGER.error("CreditAppDAOImpl :: updateCreditScore  "+exception.getMessage());
			throw new DAOException(ApplicationConstant.PROBLEM_OCCURED_MSG);
		} finally {
			entityManager.close();
		}
	...
	public List<CreditApplication> getTopBorrowerByLenderID(int lenderId) {
		...
		try {
			...
			LOGGER.error("CreditAppDAOImpl :: getTopBorrowerByLenderID  "+noResultException.getMessage());
			throw new DAOException(ApplicationConstant.NO_RESULT);
		} catch (Exception exception) {
			LOGGER.error("CreditAppDAOImpl :: getTopBorrowerByLenderID :: Exception");
			LOGGER.error("CreditAppDAOImpl :: getTopBorrowerByLenderID  "+exception.getMessage());
			throw new DAOException(ApplicationConstant.PROBLEM_OCCURED_MSG);
		} finally {
			entityManager.close();
		}
	...
	public List<CreditApplication> getCreditApplicationByBorrowerId(int borrowerId) {
		...
		try {
			...
			LOGGER.error("CreditAppDAOImpl :: getCreditApplicationByBorrowerId  "+noResultException.getMessage());
			throw new DAOException(ApplicationConstant.NO_RESULT);
		} catch (Exception exception) {
			LOGGER.error("CreditAppDAOImpl :: getCreditApplicationByBorrowerId :: Exception");
			LOGGER.error("CreditAppDAOImpl :: getCreditApplicationByBorrowerId  "+exception.getMessage());
			throw new DAOException(ApplicationConstant.PROBLEM_OCCURED_MSG);
		} finally {
			entityManager.close();
		}
	...
	public CreditApplication getCreditApplicationByAppId(int appId) {
		...
		try {
			...
			LOGGER.error("CreditAppDAOImpl :: getCreditApplicationByAppId  "+exception.getMessage());
			throw new DAOException(ApplicationConstant.PROBLEM_OCCURED_MSG);
		} finally {
			entityManager.close();
		}
	...
	public void updateCreditApplication(int applicationId, int applicationStatus) {
		...
		try {
			...
			LOGGER.error("CreditAppDAOImpl :: updateCreditApplication  "+exception.getMessage());
			throw new DAOException(ApplicationConstant.PROBLEM_OCCURED_MSG);
		} finally {
			entityManager.close();
		}
	...
	public List<CreditApplication> viewPreviousUpdatedApplications(int faId) {
		...
		try {
			...
			LOGGER.error("CreditAppDAOImpl :: viewPreviousUpdatedApplications  "+exception.getMessage());
			throw new DAOException(ApplicationConstant.PROBLEM_OCCURED_MSG);
		} finally {
			entityManager.close();
		}
