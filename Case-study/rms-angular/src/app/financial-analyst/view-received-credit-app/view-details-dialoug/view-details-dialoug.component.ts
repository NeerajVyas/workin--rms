...
let datajson={};
   ...
   /*     console.log('Policy Id',this.dataResponse.policyId[i]);
    ...
    /*    this.datasource.push({ "policyId": 'this.dataResponse.policyId[i]', "policyName": this.dataResponse.policyNamebyLender[i] , "policyValue": this.dataResponse.policyValuebyBorrower[i], "policyThreshold": this.dataResponse.policyThresholdbyLender[i], "policyWeightage" : this.dataResponse.policyWeightagebyLender[i] });
 */
